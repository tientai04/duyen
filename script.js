...
const defaultHeartImages = Array.from({ length: 8 }, (_, i) => `img/img_Duyen/Duyen${i + 1}.png`);
...
const ringTexts = [
  'Cô dược sĩ xinh đẹp nhất thế gian',
...
function preloadGalaxyAudio() {
  const audioSources = [
   "music/tiktok_music_7303131151495859457.mp3"
  ];
